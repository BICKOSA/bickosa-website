    ...
    <Layout>
      <section className="page-hero">
        <div className="container-wide px-6 sm:px-8 lg:px-12">
          <div className="max-w-xl">
            ...
            <p className="text-[12px] font-semibold uppercase tracking-[0.15em] mb-5 text-gold">Collective Impact</p>
            <h1 className="text-[42px] sm:text-[52px] font-extrabold tracking-tight leading-[1.06] mb-5 text-primary-foreground">Projects & Giving Back</h1>
            <p className="text-[16px] leading-[1.7] text-primary-foreground/55">
              BICKOSA exists not only to keep alumni connected, but to create meaningful ways for the community to give back.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-muted">
        <div className="container-wide">
          <div className="gold-accent-bar" />
          <h2 className="text-[30px] sm:text-[34px] font-bold tracking-tight text-foreground leading-[1.15] mb-10">Featured Projects</h2>
          <div className="grid md:grid-cols-3 gap-5">
            {projects.map((p) => (
              <div key={p.title} className="bg-card border border-border rounded-xl p-7 hover:shadow-md transition-all duration-300 hover:-translate-y-0.5">
      ...
      <section className="section-padding bg-background">
        <div className="container-wide">
          ...
          <div className="grid sm:grid-cols-2 gap-5 mb-10">
            {waysToSupport.map((w) => (
              <div key={w.title} className="flex items-start gap-4 bg-card border border-border rounded-xl p-6 hover:shadow-sm transition-shadow">
          ...
          <Link to="/contact" className="inline-flex items-center gap-2 h-11 px-6 text-[14px] font-semibold bg-navy text-primary-foreground rounded-md hover:bg-navy-light transition-colors">
